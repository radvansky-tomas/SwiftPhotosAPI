...
public class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    func initView() {
        ...
        mainContainerView.autoresizingMask = UIViewAutoresizing.FlexibleHeight.union(UIViewAutoresizing.FlexibleWidth)
        ...
        opacityView.autoresizingMask = UIViewAutoresizing.FlexibleHeight.union(UIViewAutoresizing.FlexibleWidth)
